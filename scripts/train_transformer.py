"""Training entry point for the vanilla Transformer baseline.

Mirrors :mod:`scripts.train` but instantiates
:class:`transformer_mt.model.TransformerTranslator` instead of the
Bi-Mamba model. All other infrastructure (data, tokenizer, training
loop, EMA, length-bucket sampler) comes from :mod:`mt_base`.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--config", default="configs/transformer_30m.yaml")
