"""Evaluate a Transformer-baseline checkpoint with SacreBLEU + chrF.

Same CLI as :mod:`scripts.evaluate` but loads
...
def main() -> None:
    ...
    model = TransformerTranslator(model_cfg).to(device)
